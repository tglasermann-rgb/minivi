...
| cost_cents | int | gramos × costo por gramo de la compra |
...
- **purchase_items**: purchase_id FK, description, type, subcategory, karat, grams, qty, qty_received, unit_cost_cents (= grams × cost_per_gram salvo override), product_id FK? (se crea al recibir).
